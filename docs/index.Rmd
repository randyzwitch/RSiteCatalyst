...
![web services access](./images/web-services-access.png)
...
+----------------------------+----------------------------------+
| Shashi Khatri              | [GitHub](https://github.com/shashispace)   LinkedIn   Twitter          |
+----------------------------+----------------------------------+
| Diego Villuendas Pellicero | [GitHub](https://github.com/dieguico)   LinkedIn   Twitter          |
+----------------------------+----------------------------------+
...
#### GetBookmarks [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetDashboards [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetElements [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetFeed [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetFeeds [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetFunctions [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetGroups [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetLogin [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetMetrics [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetQueue [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetReportDescription [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetReportSuites [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetTrackingServer [<span class="glyphicon glyphicon-link"</span>]()
...
#### GetVersionAccess [<span class="glyphicon glyphicon-link"</span>]()
...
#### BuildRealTimeReportStructure [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### QueueFallout [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### QueueOvertime [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### QueuePathing [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### QueueRanked [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### QueueSummary [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### QueueTrended [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### SaveRealTimeSettings [<span class="glyphicon glyphicon-link"</span>]()

```{r, cache=cacheflag}
#TBD
```

#### SCAuth [<span class="glyphicon glyphicon-link"</span>]()

```{r, eval=FALSE}
SCAuth("username:company", "cd1d234dee56e8202da6f7d3213eb1ef")
```

#### SubmitJsonQueueReport [<span class="glyphicon glyphicon-link"</span>]()
