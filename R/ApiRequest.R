...
#' @param SC.Debug Debug mode (defaults to value set during SCAuth)
#'
...
ApiRequest <- function(body='',func.name='',interval.seconds=2,max.attempts=1,print.attempts=FALSE, SC.Debug=SC.Credentials$debug) {
